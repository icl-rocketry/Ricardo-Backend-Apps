...
flag_lookup[16] = ['error','H_ACCEL']
flag_lookup[17] = ['error','MAG']
flag_lookup[18] = ['error','ESTIMATOR']
flag_lookup[19] = ['error','SD']
flag_lookup[20] = ['error','FLASH']
flag_lookup[21] = ['error','CAN']
flag_lookup[22] = ['error','FLIGHTCHECK']
flag_lookup[23] = ['error','ORIENTATION']
flag_lookup[24] = ['warn','BATT']
flag_lookup[25] = ['flightphase','BOOST']
flag_lookup[26] = ['flightphase','COAST']
flag_lookup[27] = ['flightphase','APOGEE']
flag_lookup[28] = ['flightphase','DROGUE CHUTE']
flag_lookup[29] = ['flightphase','MAIN CHUTE']
