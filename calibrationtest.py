...
if __name__ == "__main__":
    ...
    while True:
        ...
        angl_min = input("minimum angle: ")
        angl_max = input("maximum angle: ")
        home_angl = input("default position: ")
        cmd_packet = servocalibrate(command = 5, angl_min = int(angl_min), angl_max = int(angl_max), home_angl= int(home_angl))
